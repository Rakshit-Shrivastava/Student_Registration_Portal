        ...
        <section>
            <div class="container">
                ...
                <div class="signup-container">
                    ...
                    <form action="sign_up.php" method="POST" name="myForm1" id="myForm1" onsubmit="return  CheckPassword(document.myForm1.password1) && matchpass() && validateForm() && validateemail()">
