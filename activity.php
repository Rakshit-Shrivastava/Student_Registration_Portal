...
<div id="activity-container">
    ...
    <div class="sub-container1">
        ...
        <form class="export-form" action="download.php?<?php echo (isset($_POST['sortselect'])?$_POST['sortselect']:'All_Records')?>" method="POST">
        <!-- <?php echo (isset($_POST['sortselect'])?$_POST['sortselect']:'All_Records')?> -->
            <!-- <ul class="exp"> -->
            <!-- <li> -->
